...
const sendMailByBoleto = async (req, res) => {
  ...
  try {
    ...
    const emailTemplate = await EmailTemplate.findOne({ clave: process.env.MAIL_CNB })
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      temp = temp + `
                                                       <tr  style="text-transform: uppercase;">
                                                        ...
                                                        <th>
                                                        <a href="https://www.myticketparty.com/vista-producto/${data[i].item.uid}" class="upper" tyle="text-decoration:none;color:#13547a">
                                                        ${data[i].item.nombre}
                                                        </a>
                                                        </th>
                                                        <th>

                                                        <a href="https://www.myticketparty.com/vista-proveedor/${data[i].item.proveedor._id}" class="upper" style="text-decoration:none;color:#13547a">
...
const sendMailTemplate = async (req, res) => {
  ...
  try {
    var temp = emailTemplate[0].template
    await transporter.sendMail({
