...
const { fileUpload, retornaImagen, fileUploadGaleria, fileUploadTemplate, deleteGaleria, fileUploadFiestas, fileUploadMusicaIinvitacion, retornaMusica } = require('../controllers/uploads')
const router = Router()
